...
describe('Stat Genes Decoding', () => {
  ...
  describe('Happy Path', () => {
    test('Will decode Dominant stat genes for hero id 1000000000088', () => {
      ...
      expect(statGenesDecoded.passive1Mut).toEqual('Basic4');
      expect(statGenesDecoded.passive2Mut).toEqual('Basic8');
      expect(statGenesDecoded.active1Mut).toEqual('Basic6');
      expect(statGenesDecoded.active2Mut).toEqual('Basic4');
      expect(statGenesDecoded.statsUnknown1Mut).toEqual('Basic4');
    ...
    test('Will decode visual Recessive 1 genes for hero id 1000000000088', () => {
      ...
      expect(r1.passive1Mut).toEqual('Basic4');
      expect(r1.passive2Mut).toEqual('Basic3');
      expect(r1.active1Mut).toEqual('Basic3');
      expect(r1.active2Mut).toEqual('Basic8');
      expect(r1.statsUnknown1Mut).toEqual('Basic5');
      expect(r1.statsUnknown2Mut).toEqual('Basic1');
